...
class Solution{
    ...
    static ArrayList<ArrayList<String>> displayContacts(int n, //Number of contacts
                                        String contact[], String s)    //Array of contacts and query string
    {
        // code here
        TrieNode root=new TrieNode(); //Root of Trie
        for(String s1:contact)//   Iterating over all words
         insert(root,s1);//Inserting word
